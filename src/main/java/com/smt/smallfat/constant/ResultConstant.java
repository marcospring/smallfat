...
public class ResultConstant {
    ...
    public interface Circle{
        ...
        String IMAGE_UPLOAD_FAILED = "IMAGE_UPLOAD_FAILED";
        String IMAGE_OVERDUE = "IMAGE_OVERDUE";
        String ILLEGAL = "ILLEGAL";
        String CIRCLE_ADD_FILE = "CIRCLE_ADD_FILE";
        String CIRCLE_ADD_TIMEOUT = "CIRCLE_ADD_TIMEOUT";
        String PRAISE_IS_NULL = "PRAISE_IS_NULL";
        String FOLLOW_IS_NULL = "FOLLOW_IS_NULL";
        String DELETE_INVALID = "DELETE_INVALID";
        String CIRCLE_REPORT_IS_NULL = "CIRCLE_REPORT_IS_NULL";
        String TOO_MANY_CIRCLE_IMAGE = "TOO_MANY_CIRCLE_IMAGE";
    }
