...
import com.smt.smallfat.vo.UserRoleVO;
...
public class SysUserServiceImpl extends BaseServiceImpl implements SysUserService {
    ...
    public PaginationVo<SysUserVo> paginationSysUser(Map<String, Object> param) {
        ...
        for (SysUserVo vo : sysUserVOs) {
            ...
            for (Map.Entry<String, Object> entry : map.entrySet()) {
                ...
                if (key.equals(SysUserRole.FIELD_USER_ID))
                    params.add(ParamBuilder.nv(SysUserRole.FIELD_USER_ID, StringDefaultValue.intValue(value)));

            }
            List<UserRoleVO> sysUserRoleVOs = factory.getCacheReadDataSession().queryVOList(UserRoleVO.class, new
                    Throwable(), params);
        ...
        Integer counts = factory.getCacheReadDataSession().querySingleVO(Integer.class,
                new Throwable(), params);
        if (counts > 0) {
